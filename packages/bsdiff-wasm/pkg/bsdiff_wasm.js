/* @ts-self-types="./bsdiff_wasm.d.ts" */
...
export function diff(old, _new) {
    const ptr0 = passArray8ToWasm0(old, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(_new, wasm.__wbindgen_malloc);
 ...
 * @returns {Uint8Array}
 */
export function patch(old, patch_data) {
    const ptr0 = passArray8ToWasm0(old, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(patch_data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bsdiff_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
