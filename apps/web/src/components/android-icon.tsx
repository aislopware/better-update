/**
 * Android's mark, drawn to behave like a phosphor icon: `1em` square by default,
 * so it takes its size from whatever text it sits in, and overridable by a
 * `size-*` class. It used to hard-code 24px and carry a `data-icon` attribute
 * that nothing in Kumo styles — which is why it towered over the text inside a
 * badge.
 */
