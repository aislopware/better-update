...
export const regenerateProfileCommand = Command.make(
  "regenerate-profile",
  {
    bundle: Flag.String("bundle").pipe(
      Flag.withDescription("iOS bundle identifier (defaults to app.json)"),
      optionalFlag,
    ),
    distribution: Flag.Literals("distribution", [
      ...
      Flag.withDescription("Distribution type of the bundle configuration"),
      Flag.withDefault("ad-hoc"),
    ),
    all: Flag.Boolean("all").pipe(
      Flag.withDescription(
        "Regenerate profiles for every iOS bundle configuration on this project",
      ),
