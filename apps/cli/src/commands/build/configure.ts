...
export const configureBuildCommand = Command.make(
  "configure",
  {
    force: Flag.Boolean("force").pipe(
      Flag.withDescription("Overwrite an existing eas.json with the defaults"),
  ...
  Command.withDescription(
    "Scaffold or top up eas.json with default development/preview/production profiles",
  ),
);
